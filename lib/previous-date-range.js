...
(function() {
  var PreviousDateRange, base, moment;
  ...
  PreviousDateRange = (function() {
    ...
    PreviousDateRange.prototype.previous = function(units1, measure1, whole) {
      this.units = units1;
  ...
  if ((base = moment.fn).previous == null) {
    base.previous = function(units, measure, whole) {
